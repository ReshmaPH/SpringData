...
* The following dependency is not known to work with Spring Native: 'Oracle Driver'. As a result, your application may not work as expected.
...
```
$ docker run --rm componentmapping:0.0.1-SNAPSHOT
```
